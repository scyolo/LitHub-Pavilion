...
export default function PaperList() {
  ...
  const requestParams = filteredParams({ ...filters, sort: !isSearch && filters.sort === "relevance" ? "created_desc" : filters.sort });
  ...
  return <div className="explore-page page-enter">
    ...
    <div className="explorer-layout">
      ...
      <section className="explorer-results" aria-label="论文结果" aria-busy={result.isFetching}>
        ...
        <p className="results-note"><Icon name="info" size={14} />支持英文词组检索；主题标签为自动规则归类，发表归属待核验的记录会单独提示。</p>
      </section>
    </div>
  </div>;
}
